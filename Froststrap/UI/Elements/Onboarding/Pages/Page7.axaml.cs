...
{
    internal partial class Page7 : UserControl, IDisposable
    {
        private static readonly LucideIconNames[] IconCycle = [LucideIconNames.PartyPopper, LucideIconNames.Rocket];
