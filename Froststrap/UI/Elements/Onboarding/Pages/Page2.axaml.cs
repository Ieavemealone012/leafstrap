...
{
    internal partial class Page2 : UserControl, IDisposable
    {
        private static readonly LucideIconNames[] IconCycle = [LucideIconNames.Sparkles, LucideIconNames.Palette];
