...
{
    internal partial class Page5 : UserControl, IDisposable
    {
        private static readonly LucideIconNames[] IconCycle = [LucideIconNames.Link2, LucideIconNames.SquareArrowOutUpRight];
